...
\item The backward chainer is then modified by inserting conditionals
  at every non-deterministic intersection.  These conditionals are in
  charge of deciding whether to prune or to continue a particular path
  of the backward chainer.  The modified base case of the backward
  chainer is given in
  ...
  be found under the Controlled Backward Chainer Section of
  ~\cite{Geisweiller2024ICM}.
