...
iterate this approach a few times.
...
useful to rank the patterns according to some measure of
interestingness \cite{Vreeken2014}.  One can also use pattern mining
in combination with other pattern recognition techniques,
...
miner in OpenCog is to mine inference traces, discover control rules,
and apply these control rules to speed up reasoning in general, akin
to a Heuristic Algorithmic Memory \cite{Ozkural2011} for reasoning. By
...
(Jeffreys prior% \cite{Jeffreys46Invariant}
