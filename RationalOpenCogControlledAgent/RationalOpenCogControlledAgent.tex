%% TODO:
%%
%% 1. Explain that action plan with 3 actions, are selected, then with
%%    2 actions, then with 1 action, then reward.
%%
%% 2. Syntax sugar so that outside(house) is a temporal predicate,
%%    same thing for datum@timestamp.
...
necessary cognitive schematics and, as a result, accumulates more
