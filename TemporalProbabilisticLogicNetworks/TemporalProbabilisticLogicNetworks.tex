...
% ⊢
% (P⩘ᵀ¹A)↝ᵀ²R
The whole inference tree is given below (using $k=800$ as \emph{Lookahead}
in the truth value formulea).
{\tiny
\begin{prooftree}
  \AxiomC{$\!\!\!\! P(1) \measeq <\!1, 1\!> \hspace{0.2cm}
    P(2) \measeq <\!1, 1\!> \hspace{0.2cm}
    Q(1+1) \measeq <\!0, 1\!> \hspace{0.2cm}
    Q(2+1) \measeq <\!1, 1\!>\!\!\!\!\!\!\!\!\!\!\!\!\!$}
  \RightLabel{(PIDI)}
  \UnaryInfC{$\!\!\!\! P \lpreimp{1} Q \measeq <\!0.5, 0.5\!>$}
  \AxiomC{$\!\!\!\!\!\!\!\!\!\!\!\!\!\!\!Q\lpreimp{2} R \measeq <\!1, 0.5\!> \hspace{0.2cm}
    P \measeq <\!1, 0.1\!> \hspace{0.2cm}
    Q \measeq <\!0.5, 1\!> \hspace{0.2cm}
    R \measeq <\!1, 1\!>\!\!\!\!\!\!\!\!\!\!\!\!\!\!\!\!$}
  \RightLabel{(TD)}
  \BinaryInfC{$P \lpreimp{3} R \measeq <\!1, 0.091\!>$}
\end{prooftree}}
