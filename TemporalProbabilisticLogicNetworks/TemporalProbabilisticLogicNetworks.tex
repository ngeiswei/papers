...
vocabulary for representing temporal and procedural knowledge.  The
Chapter 14 of the PLN book~\cite{Goertzel09PLN} does that.  However we
have found that some definitions are ambiguous or incorrect.  This
paper has been written to remedy that.
