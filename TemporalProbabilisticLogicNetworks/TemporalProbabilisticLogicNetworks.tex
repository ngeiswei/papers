...
We have introduced alternate definitions of temporal constructs for
carrying temporal and procedural reasoning with PLN.  Future
directions include adding inference rules to support more ways of
combining action plans possibly described as Behavior Trees;
introducing Event Calculus operators as predicate transformers
(similar to how $\TLag$ and $\TLead$ are defined); supporting
continuous time and temporal intervals.
