...
%% \newcommand{\MSeqAnd}{\curlywedge}
%% \newcommand{\MSeqOr}{\curlyvee}
%% \newcommand{\MSeqAnd}{\stackrel{\wedge}{\prec}}
%% \newcommand{\MSeqOr}{\stackrel{\vee}{\prec}}
\newcommand{\MSeqAnd}[1]{\stackrel{\prec}{\wedge}^{#1}\!\!\!}
\newcommand{\MSeqOr}[1]{\stackrel{\prec}{\vee}^{#1}\!\!\!}
%% \newcommand{\MSeqAnd}{\accentset{\prec}{\wedge}}
%% \newcommand{\MSeqOr}{\accentset{\prec}{\vee}}
%% \newcommand{\MForeSeqAnd}{\underrightharpdown{^}}
%% \newcommand{\MSeqAnd}{\underrightharpdown{$\wedge$}}
%% \newcommand{\MSeqAnd}{\underset{\rightharpoondown}{\wedge}}
%% \newcommand{\MSeqAnd}{\stackrel{\wedge}{\rightharpoondown}}
\newcommand{\nstackrel}[2]{%
...
%% \newcommand{\MLag}[2]{\accentset{\overrightharp}{#1}^{#2}}
%% \newcommand{\MLead}[2]{\overleftharp{#1}^{#2}}
